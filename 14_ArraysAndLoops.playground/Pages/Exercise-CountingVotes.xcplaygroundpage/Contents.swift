...
print(yesVotesForMascot)
print(noVotesForMascot)
...
if yesVotesForMascot > noVotesForMascot {
    print("The vote has passed")
} else {
    print("The vote has failed. Try again losers.")
}
...
var yesVotesForInstalls = 0
var noVotesForInstalls = 0


for vote in shouldInstallCoffeeVendingMachineVotes {
    if vote == true {
        yesVotesForInstalls += 1
    } else if vote == false {
        noVotesForInstalls += 1
    }
}
print(yesVotesForInstalls)
print(noVotesForInstalls)

if yesVotesForInstalls > noVotesForInstalls {
    print("The vote has passed")
} else if yesVotesForInstalls < noVotesForInstalls {
    print("The vote has failed. Try again losers.")
} else {
    print("We're going to have to redo this - it's a draw.")
}
...
func printResults(forIssue: String, withVotes: Bool) {
    ...
    print(forIssue, "\(yesVotesForMascot) yes, \(noVotesForMascot) no")

}

printResults(forIssue: "Should we change the mascot?", withVotes: true)
