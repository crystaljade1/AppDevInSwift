...
*/
let stepsWalked = [4000, 20323, 4032, 4334, 656, 3342, 36778, 3436, 7453, 2453, 2564, 756, 9863, 3553, 5342, 4324, 4564, 3343, 3442, 4566, 7553, 1234, 5356, 7564]
stepsWalked.count
...
func tellDistanceFromGoal(input: Int) {

    for steps in stepsWalked {
        if steps < 1000 {
            print("Do better. ")
        } else if steps > 1000 && steps < 2500 {
            print("Not bad, but do better.")
        } else if steps > 2500 && steps < 4000 {
            print("You've been active lately! Keep it up or be fat.")
        } else if steps > 4000 && steps < 10999 {
            print("You're the bomb! Can you hit 11K?")
        } else {
            print("I always knew you had it in you.")
        }
    }
}
tellDistanceFromGoal(input: 5000)
...
for steps in stepsWalked {
    tellDistanceFromGoal(input: 11000)
}
