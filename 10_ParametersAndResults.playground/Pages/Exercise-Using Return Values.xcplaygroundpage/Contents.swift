...
let impossibleBeliefs = impossibleBeliefsCount(pigsFlying: 8, frogsBecomingPrinces: 0, multipleLightningStrikes: 8)
let impossibleThings = impossibleThingsPhrase(numberOfImpossibleThings: impossibleBeliefsCount(pigsFlying: 8, frogsBecomingPrinces: 0, multipleLightningStrikes: 8), meal: "mac and cheese")

print(impossibleThings)
