...
func printFavorite(categoryOfThing: String, favoriteSong: String) {
    let categoryOfThing = "song"
    let favoriteSong = "it was a good day"
    
    print("My favorite \(categoryOfThing) is \(favoriteSong).")
}
