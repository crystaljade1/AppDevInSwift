...
func makeFavorite(categoryOfThing: String, favorite: String) -> String {
    ...
    let myFavoriteString = "My favorite \(categoryOfThing) is \(favorite)."
    
    return myFavoriteString
}

let sentence = makeFavorite(categoryOfThing: "food", favorite: "pizza")
...
let newSentence = makeFavorite(categoryOfThing: "startup", favorite: "HausCall")
...
let finalSentence = "Hello, my name is Crystal. \(sentence) \(newSentence)"
print(finalSentence)
