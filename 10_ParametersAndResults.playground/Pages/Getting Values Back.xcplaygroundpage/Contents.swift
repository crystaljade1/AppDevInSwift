...
func holidayVideoCountMessage(holidayVideoCount: Int, eachVideoDuration: Int) -> String {
    _ = 20
    let holidayVideoCount = 100
    
    return ("\(namedVideoMessage).\n You have \(holidayVideoCount) videos in your Holiday Video Collection!")
}

print(holidayVideoCountMessage(holidayVideoCount: 7, eachVideoDuration: 20))
