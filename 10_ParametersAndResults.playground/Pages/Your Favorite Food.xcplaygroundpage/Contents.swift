...
*/
var favoriteWord = "okay?"
let description = ("Okay, listen closely to hear my favorite word, \(favoriteWord)?")

func printFavorite(word: String, sentence: String) {
    _ = description
    print(description)
}
printFavorite(word: favoriteWord, sentence: description)
