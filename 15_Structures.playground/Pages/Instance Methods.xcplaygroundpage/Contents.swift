...
struct Rectangle {
    ...
    func biggerThan(_ rectangle: Rectangle, otherRectangle: Rectangle) -> Bool {
        let bool = Bool()
        return bool
    }
}
...
let rectangle = Rectangle(width: 10, height: 10, area: 100)
let otherRectangle = Rectangle(width: 10, height: 20, area: 200)
//
