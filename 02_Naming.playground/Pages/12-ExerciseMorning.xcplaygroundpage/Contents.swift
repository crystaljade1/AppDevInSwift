...
let totalMorningTime = (brushTeeth + washFace + shower + eatBreakfast + getDressed)

let danceInMirror = 10
let playWithNoah = 7
let watchTV = 20
...
let extraActivities = danceInMirror + playWithNoah + watchTV
let mandatoryActivities = brushTeeth + washFace + shower + eatBreakfast + getDressed
