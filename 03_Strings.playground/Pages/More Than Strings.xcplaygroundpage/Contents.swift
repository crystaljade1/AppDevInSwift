...
let newGoalieReportString = "This game was crazy. \(goalieName) absolutely killed it with \(firstHalfSaves) saves in the first half! Just when we thought it couldn't get any better, he scored \(secondHalfSaves) more saves in the second half with \(overtimeSaves) more overtime saves. He's the best lacrosse player in Atlanta."
