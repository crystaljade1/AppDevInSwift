 ...
 */
var megabyte = 1
let gigabyte = 1000 * megabyte
let iPhoneCapacity = 5000 * megabyte
let oneMinuteOfVideo = 150 * megabyte
let availableVideoSpaceByMinute = iPhoneCapacity / oneMinuteOfVideo

let descriptionOfAvailableMinutes = "You can record \(availableVideoSpaceByMinute) more minutes of video."
